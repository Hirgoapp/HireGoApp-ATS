...
$urls = @(
    "$base/api/v1/clients?page=1&limit=1",
    "$base/api/v1/jobs?page=1&limit=1",
    "$base/api/v1/submissions?skip=0&take=5",
    "$base/api/v1/interviews?page=1&limit=1",
    "$base/api/v1/offers?page=1&limit=1"
)
