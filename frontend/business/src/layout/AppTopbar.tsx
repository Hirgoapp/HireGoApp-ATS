        ...
        <header className="app-topbar">
            ...
            <div className="topbar-right">
                <div className="clock-chip" title={`Workspace timezone: ${workspaceTimezone}`}>
                    ...
                    {timezoneMismatch ? (
                        <div className="clock-meta">Local: {localTimezone}</div>
                    ) : null}
                </div>
                        ...
                        <div className="settings-popover" role="dialog" aria-label="Layout settings">
                            ...
                            <div className="settings-section">
                                ...
                                <div className="segmented-control">
                                    <button
                                        type="button"
                                        className={`segment ${density === 'comfortable' ? 'active' : ''}`}
                                    ...
                                    <button
                                        type="button"
                                        className={`segment ${density === 'compact' ? 'active' : ''}`}
                ...
                <div className="user-chip">
                    {user?.avatarUrl ? (
                        <img src={user.avatarUrl} alt={user.firstName || 'User'} className="user-avatar" />
                    ) : (
                        <div className="user-avatar user-avatar-fallback">{userInitials}</div>
                    )}
                    <div>
                        <div className="user-name">{user?.firstName || 'User'}</div>
                        <div className="user-meta">{user?.role || 'member'}</div>
